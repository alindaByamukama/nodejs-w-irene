...
- Install MongoDB and MongoCompass
...
- [ ] Assignment: Add Pug files to your ufarm project
  - [ ] Push your files to GitHub
  - [ ] Share the link to the repo
- [building-a-static-website-with-nodejs-express-and-pug](https://zhishenyong.com/building-a-static-website-with-nodejs-express-and-pug)